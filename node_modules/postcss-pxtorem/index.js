...
module.exports = postcss.plugin('postcss-pxtorem', function (options) {
    ...
    return function (css) {
        ...
        options = options || {};
        var rootValue = options.rootValue || 16;
        var unitPrecision = options.unitPrecision || 5;
        var selectorBlackList = options.selectorBlackList || [];
        var propWhiteList = options.propWhiteList || ['font', 'font-size', 'line-height', 'letter-spacing'];
        var replace = (options.replace === false) ? false : true;
        var mediaQuery = options.mediaQuery || false;
